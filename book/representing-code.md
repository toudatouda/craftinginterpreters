...
[Note: the java prog must be run from the higher lair dir of the com dir;
 compile: (at doc java) javac com/craftinginterpreters/tool/GenerateAst.java;
 run: (at doc java) java com.craftinginterpreters.tool.GenerateAst com.craftinginterpreters.lox]
...
to output an updated "Expr.java" file.

[Note: the java prog must be run from the higher lair dir of the com dir;
 compile: (at doc java) javac com/craftinginterpreters/tool/GenerateAst.java;
 run: (at doc java) java com.craftinginterpreters.tool.GenerateAst com.craftinginterpreters.lox]

It contains a generated Visitor
